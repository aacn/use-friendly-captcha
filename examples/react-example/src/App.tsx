...
const App: React.FC = () => {
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    // Here would go your axios request to your backend that gets the data from the captcha (solution & siteKey)
    // and ofcourse your form data. Please refer to the nextjs example, which provides an inbuild backend API, where
    // you can find an in-depth example on how to use the backend function of this library.
    alert('bip bup, doing a server request...');
  }
  return (
      <>
        <main className="bg-gray-700 min-h-screen h-full p-4 pt-20 flex flex-col justify-start items-center">
          ...
          <h2 className="text-2xl text-cyan-400 font-thin">React with TypeScript</h2>
